...
static U8 gFRU_Info[] =
{
  ...
  'I','C','L','-','C','E','R','N',    // Board Manufacturer
  /* 23 */
  ...
  'I','C','L','-','C','E','R','N',    // Product Manufacturer
  0xC3,                   // Product Product Name String Type / Length
  /* 53 */
  'F','C','7',              // Product Name
  0xC4,                    // Product Part Num
  '-','R','2',' ', 	   // Product Version
  /* 61 */
  0xC9,                    // Product Version
  'M','M','C',' ','v','1','.','6','4', // Product Part Num  --> however, based on 1.6.0 tag
  ...
  0x28,					// Changed to 4A @ 12V for TCDS
  /* 91 */
  0x00, 0x00
